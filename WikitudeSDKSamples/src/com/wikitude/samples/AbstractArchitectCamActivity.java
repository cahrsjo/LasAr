 ...
 *
 */
public abstract class AbstractArchitectCamActivity extends Activity implements ArchitectViewHolderInterface, SensorEventListener{
	...
	***************************/
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if(type == Sensor.TYPE_ACCELEROMETER){
			...
			System.out.println("ACCX:" + event.values[0]);
			System.out.println("ACCy:" + event.values[1]);
			System.out.println("ACCz:" + event.values[2]);
		}
		...
		*/
		...
		try {
			this.architectView.callJavascript("alert("+obj.getDouble("azimuth")+")");
		} catch (JSONException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
	...
	***************************/
	...
	public void onCreate( final Bundle savedInstanceState ) {
		...
		***************************/
		...
		mAcceleration = mSensorManager.getDefaultSensor(Sensor.TYPE_ACCELEROMETER);//TYPE_ROTATION_VECTOR
